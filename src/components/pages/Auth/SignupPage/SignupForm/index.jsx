    ...
    <StyledParentForm>
      <StyledSignupForm>
        <form>
          ...
          <StyleAppleButton>
            ...
            <StyleGoogleButton>
              <CustomButton
                variant="contained"
                icon={
                  <Image src={Google} alt="google" width={35} height={36} />
                }
            ...
            <StyledNameFeild>
          <SignupTextFeild placeholder='First name' 
          style={{
            width:'270px',
          }}
          />
          <SignupTextFeild placeholder='Last name'
          style={{
            width:'270px',
          }}
          />
          </StyledNameFeild>
          <SignupTextFeild placeholder='Email'/>
          <PasswordInput/>
          <TextField 
          ...
          SelectProps={{ 
            native: true, 
            sx: { width: "562px", height: "45px",marginLeft:"9px",marginTop:"10px",marginBottom:"10px"}, 
          }} 
          variant="outlined" 
        > 
         ...
         label={
          ...
          <a href="/terms" style={{color:"green",textDecoration:"none"}}>Upwork Terms of Services</a>
         
          . including the 
          <a href="/terms" style={{color:"green",textDecoration:"none"}}>user Agreement</a>
           and 
           <a href="/terms" style={{color:"green",textDecoration:"none"}}> Privacy Policy</a>
